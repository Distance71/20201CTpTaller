...
typedef enum {
    ...
    PLAYER_3_DEAD = 34,
    PLAYER_4_DEAD = 35,
    EXPLOSION_ANIMATION_BOSS_1 = 36,
    EXPLOSION_ANIMATION_BOSS_2 = 37,
    EXPLOSION_ANIMATION_BOSS_3 = 38,
    EXPLOSION_ANIMATION_BOSS_4 = 39,
    EXPLOSION_ANIMATION_BOSS_5 = 40,
    EXPLOSION_ANIMATION_BOSS_6 = 41,
    EXPLOSION_ANIMATION_BOSS_7 = 42,
    EXPLOSION_ANIMATION_BOSS_8 = 43,
    EXPLOSION_ANIMATION_BOSS_9 = 44,
    EXPLOSION_ANIMATION_BOSS_10 = 45,
    EXPLOSION_ANIMATION_BOSS_11 = 46,
} elementType_t;
